      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-xl text-vidaia-charcoal/60 max-w-2xl mx-auto">
            Itinerarios diseñados con detalle, todos adaptables a tus fechas y presupuesto
          </p>
        </div>
              ...
              >
                ...
                <div className="p-5 flex flex-col flex-1">
                  ...
                  <div className="flex items-center justify-between mt-auto pt-3 border-t border-vidaia-light/60">
                    ...
                    >
                      {trip.hasItinerary ? 'Ver itinerario' : 'Solicitar información'}
        ...
        <div className="text-center mt-12">
          ...
          >
            Ver todos los viajes a Argentina
