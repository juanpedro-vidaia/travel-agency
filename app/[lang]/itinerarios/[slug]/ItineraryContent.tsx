...
export default function ItineraryContent({
  ...
  return (
    <main className="min-h-screen bg-white pb-20 lg:pb-0">
      ...
      <LangLink
        href={requestHref}
        className="fixed bottom-6 left-4 right-[80px] z-50 lg:hidden flex items-center justify-center gap-2 bg-vidaia-earth hover:bg-vidaia-brown text-white font-semibold px-6 py-3.5 pr-16 sm:pr-20 rounded-full transition-colors text-base"
      >
        {content.hero.ctaButton}
        <ArrowRight className="w-5 h-5" />
      </LangLink>
