...
export const metadata: Metadata = {
  title: STATIC_CONTENT.es.legalNoticePage.metadata.title,
  description: STATIC_CONTENT.es.legalNoticePage.metadata.description,
}

export default function AvisoLegalPage() {
  const content = STATIC_CONTENT.es.legalNoticePage
