...
const trips: Trip[] = [
  ...
  {
    id: 'peru-contrastes-iquitos',
    slug: 'peru-contrastes-iquitos',
    content: {
      es: {
        title: 'Perú Contrastes: Lima, Paracas, Amazonia, Cusco y Machu Picchu',
        subtitle: 'Lima · Paracas · Iquitos · Cusco · Machu Picchu · Valle Sagrado',
      }
    },
    country: 'peru',
    days: 12,
    nights: 11,
    priceFrom: 0,
    imageKey: 'TRIPS.PERU_CONTRASTES_IQUITOS',
    featured: false,
    active: false,
    hasItinerary: false,
    tags: ['nature', 'wildlife', 'culture', 'adventure'],
    includesInternationalFlights: true,
    includesDomesticFlights: true,
    relatedTrips: [
      { slug: 'lo-mejor-de-peru', es: { reason: 'Versión sin selva, más centrada en costa y sierra' } },
    ],
    honeymoonFeatured: false,
    season: 'winter',
    bestMonths: [4, 5, 6, 7, 8, 9, 10],
